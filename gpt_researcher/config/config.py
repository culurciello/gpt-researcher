...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.fast_llm_model = os.getenv('FAST_LLM_MODEL', 'ollama')#"meta-llama/Meta-Llama-3-8B-Instruct")
        self.smart_llm_model = os.getenv('SMART_LLM_MODEL', 'ollama')#"meta-llama/Meta-Llama-3-8B-Instruct")
