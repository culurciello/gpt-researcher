...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.retriever = os.getenv('RETRIEVER', "tavily") #"duckduckgo")
        self.embedding_provider = os.getenv('EMBEDDING_PROVIDER', 'huggingface')#'openai')
        self.llm_provider = os.getenv('LLM_PROVIDER', "local")
        self.fast_llm_model = os.getenv('FAST_LLM_MODEL', 'ollama')#"gpt-3.5-turbo-16k")
        self.smart_llm_model = os.getenv('SMART_LLM_MODEL', 'ollama')#"gpt-4o")
